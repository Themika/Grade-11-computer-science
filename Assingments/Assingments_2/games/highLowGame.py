...
class HighLowGame:
    ...
    def create_mode_selection_ui(self):
        ...
        # Normal mode button
        normal_button = tb.Button(button_frame, text="Normal", command=self.show_difficulty_options, bootstyle="success-outline", padding=10)
        normal_button.grid(row=0, column=0, padx=10)

        # Timer mode button
        timer_button = tb.Button(button_frame, text="Timer", command=lambda: self.start_game("timer"), bootstyle="warning-outline", padding=10)
        timer_button.grid(row=0, column=1, padx=10)
    ...
    def show_difficulty_options(self):
        ...
        # Easy button
        easy_button = tb.Button(button_frame, text="Easy", command=lambda: self.start_game("easy"), bootstyle="success-outline", padding=10)
        easy_button.grid(row=0, column=0, padx=10)

        # Medium button
        medium_button = tb.Button(button_frame, text="Medium", command=lambda: self.start_game("medium"), bootstyle="warning-outline", padding=10)
        medium_button.grid(row=0, column=1, padx=10)

        # Hard button
        hard_button = tb.Button(button_frame, text="Hard", command=lambda: self.start_game("hard"), bootstyle="danger-outline", padding=10)
        hard_button.grid(row=0, column=2, padx=10)

        # Back button
        back_button = tb.Button(button_frame, text="Back", command=self.create_mode_selection_ui, bootstyle="danger-outline", padding=10)
    ...
    def create_game_ui(self):
        ...
        # Guess button
        guess_button = tb.Button(self.root, text="Guess", command=self.check_guess, bootstyle="primary-outline")
        ...
        # Back button
        back_button = tb.Button(self.root, text="Back", command=self.create_mode_selection_ui, bootstyle="danger-outline")
