...
class TicTacToe:
    ...
    def show_lobby_options(self):
        ...
        create_lobby_1v1v1_button = ttk.Button(lobby_frame, text="Create 1v1v1 Lobby", command=lambda: self.create_lobby("1v1v1"), bootstyle="primary")
        create_lobby_1v1v1_button.grid(row=0, column=1, padx=50, pady=20)
